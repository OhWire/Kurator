...
const initialValues = {
  kriterien: [
    { name: 'Kleidungsauswahl', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Tags', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Nachts', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Individuelle Bedürfnisse', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Unabhängigkeit', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
          ...
          <div className="flex h-[15%] justify-between items-center">
            <div className="flex p-10 py-16">
              <h2 className="text-4xl font-fjalla p-6">
                Pflegeplanung<span className="text-xl">_Sich Kleiden</span>
              </h2>
            </div>
          </div>

...
const initialValues = {
  kriterien: [
    { name: 'Inkotinenz', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Darm', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Blase', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Toilettentraining', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Hilfsmittel', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
          ...
          <div className="flex h-[15%] justify-between items-center">
            <div className="flex p-10 py-16">
              <h2 className="text-4xl font-fjalla p-6">
                Pflegeplanung<span className="text-xl">_Ausscheiden</span>
              </h2>
            </div>
          </div>

...
const initialValues = {
  kriterien: [
    { name: 'Tagesgestaltung', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Hobbies', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Aktivitäten', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Selbstständig', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Mit anderen', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Sexualität', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Nähe/Distanz', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Scham', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Rollenverhalten', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Sozialverhalten', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Selbstwert u. Körpergefühl', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
          ...
          <div className="flex h-[15%] justify-between items-center">
            <div className="flex p-10 py-16">
              <h2 className="text-4xl font-fjalla p-6">
                Pflegeplanung<span className="text-xl">_Beschäftigung</span>
              </h2>
            </div>
          </div>

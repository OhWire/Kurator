...
const initialValues = {
  kriterien: [
    { name: 'Angst', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Alter/Krankheit', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Isolation', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Sterben und Tod', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Biografie', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Unterstützung', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Hoffnung', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Sicherheit', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Sinn', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Integration', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
          ...
          <div className="flex h-[15%] justify-between items-center">
            <div className="flex p-10 py-16">
              <h2 className="text-4xl font-fjalla p-6">
                Pflegeplanung<span className="text-xl">_Umgebung</span>
              </h2>
            </div>
          </div>

...
const initialValues = {
  kriterien: [
    { name: 'Orientierungshilfen', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Verhüten und Gefahren', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Fixierungen', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Psychische Sicherheit', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },

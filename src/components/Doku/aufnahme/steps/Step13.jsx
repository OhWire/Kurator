...
const initialValues = {
  kriterien: [
    ...
    { name: 'Angehörige', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Freunde', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Nachbarn', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Mitbewohner', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Mitarbeiter', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Integration', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Kontakte', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },

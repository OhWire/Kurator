...
const initialValues = {
  kriterien: [
    { name: 'Schlafgewohnheiten', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Schlafrythmus', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Schlafstörungen', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Schlaf-/Wachumkehr', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Tag-/Nachtumkehr', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
    { name: 'Medikamente', probleme: '', ressourcen: '', ziele: '', massnahmen: '', scala: '' },
          ...
          <div className="flex h-[15%] justify-between items-center">
            <div className="flex p-10 py-16">
              <h2 className="text-4xl font-fjalla p-6">
                Pflegeplanung<span className="text-xl">_Ruhen und Schlafen</span>
              </h2>
            </div>
          </div>
